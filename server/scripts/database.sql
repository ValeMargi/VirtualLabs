create or replace table avatar_professor
(
	id bigint not null
		primary key,
...
create or replace table avatar_student
(
	id bigint not null
		primary key,
	name_file varchar(255) null,
...
INSERT INTO virtualLabs.hibernate_sequence (next_val) VALUES (0);

create or replace table photo_assignment
(
	id bigint not null
		primary key,
	name_file varchar(255) null,
...
create or replace table photo_modelvm
(
	id bigint not null
		primary key,
	name_file varchar(255) null,
...
create or replace table photovm
(
	id bigint not null
		primary key,
	name_file varchar(255) null,
...
create or replace table professor_course
(
...
create or replace table photo_correction
(
	id bigint not null
		primary key,
	name_file varchar(255) null,
...
create or replace table photo_version_homework
(
	id bigint not null
		primary key,
	name_file varchar(255) null,
...
create or replace table student_course
(
...
create or replace table team_student
(
...
create or replace table token_registration
(
	id varchar(255) not null
		primary key,
	expiry_date datetime null,
...
create or replace table password_reset_token
(
	id bigint not null
		primary key,
	expiry_date datetime null,
...
create or replace table vm_owners
(
...
create or replace table vm_student
(
	vm_id bigint not null,
	student_id varchar(255) not null,
